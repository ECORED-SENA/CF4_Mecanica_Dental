  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Identificación de componentes de aparatología
        p.mb-4 El aprendiz debe ubicar y adaptar los componentes de la placa en la posición correcta sobre el modelo.
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Completar frases / Opción múltiple
            .col-auto
